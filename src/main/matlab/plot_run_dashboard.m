...
% (n) Draw car
x_rr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.right_tire.x');
y_rr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.right_tire.y');
...
if i>=i_start && i<=i_end
    update_distance_text(s(i));
end
if i>=i_end
    update_distance_text(laptime);
end

if i>=i_start
    update_time_text(t(i));
end
...
function update_distance_text(dist)
    distance_ax = axes('Position', [0.02, 0.08, 0.15, 0.15]);
    set(distance_ax, 'visible', 'off')
    % Add the text to the plot
    text(0.0, 0.0, sprintf('Distance: %.3f m', dist), 'Parent', distance_ax, ...
         'HorizontalAlignment', 'left', ...
         'VerticalAlignment', 'bottom', ...
         'FontSize', 25, ...
         'FontWeight', 'bold', ...
         'Color', 'black', ...
         'BackgroundColor', [0.75 0.75 0.75 0.5]); % Semi-transparent black background
end

function update_time_text(time)
    time_ax = axes('Position', [0.02, 0.02, 0.05, 0.05]);
    set(time_ax, 'visible', 'off')
    % Add the text to the plot
    text(0.0, 0.0, sprintf('Time: %.3f s', time), 'Parent', time_ax, ...
         'HorizontalAlignment', 'left', ...
         'VerticalAlignment', 'bottom', ...
         'FontSize', 25, ...
         'FontWeight', 'bold', ...
...
for i_point = i_start:i
    a_x(i_point-i_start+1) = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i_point),qa(:,i_point),[u(1,i_point),0.0,u(2:3,i_point)'],s(i_point),'ax')/9.81;
    a_y(i_point-i_start+1) = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i_point),qa(:,i_point),[u(1,i_point),0.0,u(2:3,i_point)'],s(i_point),'ay')/9.81;
end
...
kappa_fl = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'front_axle.left_tire.kappa');
kappa_fr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'front_axle.right_tire.kappa');
kappa_rl = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.left_tire.kappa');
kappa_rr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.right_tire.kappa');
lambda_fl = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'front_axle.left_tire.lambda');
lambda_fr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'front_axle.right_tire.lambda');
lambda_rl = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.left_tire.lambda');
lambda_rr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.right_tire.lambda');
...
% (8) Get tire forces
Fx_fl = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'front_axle.left_tire.Fx');
Fx_fr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'front_axle.right_tire.Fx');
Fx_rl = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.left_tire.Fx');
Fx_rr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.right_tire.Fx');

Fy_fl = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'front_axle.left_tire.Fy');
Fy_fr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'front_axle.right_tire.Fy');
Fy_rl = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.left_tire.Fy');
Fy_rr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.right_tire.Fy');
...
dissipation_fl = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'front_axle.left_tire.dissipation');
dissipation_fr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'front_axle.right_tire.dissipation');
dissipation_rl = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.left_tire.dissipation');
dissipation_rr = calllib("libfastestlapc","vehicle_get_output",vehicle,q(:,i),qa(:,i),[u(1,i),0.0,u(2:3,i)'],s(i),'rear_axle.right_tire.dissipation');
...
function plot_telemetry(i,t,q,~,u)
